          ...
          <div className="md:w-1/3 w-full bg-gray-100 p-6 rounded-lg shadow-md h-fit sticky top-20">
           ...
           <button
                  ...
                  <div className="grid grid-cols-4 gap-4">
                      ...
                      <img
                        ...
                        onClick={() =>
                          setSelectedImage((prev) =>
                            prev === clipart.src ? null : clipart.src
                          )
                        }
                      />
                    ))}
                    ...
                    <div className="flex justify-between items-center mt-6">
                      <button
                        className="px-6 py-2 rounded-full border border-brown-700 text-brown-700 font-bold"
                        onClick={handleClipartClick}
                      >
                        Back
                      </button>
                      <button
                        ...
                        onClick={() => setShowClipartPanel(false)} // You might want to handle confirmation differently
