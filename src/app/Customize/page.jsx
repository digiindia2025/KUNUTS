    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        >
          <div className="w-16 h-16 flex items-center justify-center rounded-full bg-blue-100">
            {/* Text SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 6.827 6.827" className="w-6 h-6">
              <style>{`.fil0{fill:none}`}</style>
              <path className="fil0" d="M0 0h6.827v6.827H0z" />
              <path className="fil0" d="M.853.853h5.12v5.12H.853z" />
              <path d="M5.382 3.794a2.66 2.66 0 0 1-.595.139c-.15.02-.257.045-.318.072a.31.31 0 0 0-.195.292c0 .098.037.179.11.244.074.064.181.096.323.096.14 0 .266-.03.375-.092a.57.57 0 0 0 .242-.252.876.876 0 0 0 .058-.365v-.134z" fill="#5f5f5f" />
              <path d="M1.817 3.654h1.008l-.31-.822a8.099 8.099 0 0 1-.21-.616c-.039.19-.092.38-.161.567l-.327.871zM.96 4.874l1.141-2.97h.424l1.216 2.97h-.448l-.347-.9H1.704l-.326.9H.96z" fill="#727272" />
            </svg>
          </div>
