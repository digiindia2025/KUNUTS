...
const sidebarOptions = [
  { id: 1, title: "Why Choose Us?", content: "We provide 100% organic and fresh dry fruits, sourced from the best farms worldwide." },
  { id: 2, title: "Our Quality", content: "Premium quality dry fruits with no preservatives, ensuring natural taste and health benefits." },
  { id: 3, title: "Fast Delivery", content: "We offer fast and secure delivery so you get the freshest products quickly." },
  { id: 4, title: "Affordable Prices", content: "Best prices in the market with seasonal discounts and bulk purchase offers." },
  { id: 5, title: "Customer Support", content: "Our 24/7 customer support ensures you always get the best service." },
];

export default function SidebarExample() {
  const [isSidebarOpen, setSidebarOpen] = useState(false);
  const [selectedOption, setSelectedOption] = useState(sidebarOptions[0]); // Default selection: "Why Choose Us?"
