    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <form onSubmit={onSubmitHandler} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow-md p-6 rounded-lg">
          ...
          <p className="text-gray-600">Discounted Price: <span className="font-semibold">₹{adjustedTotalPrice}</span></p>

          <button type="submit" className="w-full bg-blue-500 text-white py-2 px-4 rounded-md mt-4 hover:bg-blue-600">
            Place Order
          </button>
        </div>
